            ...
            <div class="container">
                    <div class="col-6">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="نام خود را وارد کنید">
                            ...
                            <br>
                            <input type="submit" class="btn btn-lg btn-warning" value="ثبت نام">
                            <br>
                            <br>
                            <div class="p-3">
                                <h6>
                                    <a href="/hamster/signin" class='text-warning link-underline-dark'>حساب کاربری دارید؟ وارد شوید</a>
                                </h6>
                            </div>
                        </form>
                    </div>
